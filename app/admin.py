...
from core.models import complains, roomRequest, notifications, medical, laundaryRequest, messFeed
...
def accept(modeladmin, request, queryset):
    ...
    messages.add_message(request, messages.INFO,
                         'Okay! Following request have been accepted!')
...
def decline(modeladmin, request, queryset):
    for i in list(queryset):
        ...
        i.delete()
    messages.add_message(request, messages.INFO,
                         'The selected requests are declined!!')
...
@admin.register(messFeed)
class MessFeedAdmin(admin.ModelAdmin):
    list_display = ("name", "hostel", "phoneno", "feedback")
    actions = [accept, decline]
