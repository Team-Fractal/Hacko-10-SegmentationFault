...
from core.forms import RoomCleaningForm, ComplaintForm, medicalForm, LaundaryForm, MessFeedbackForm
from core.models import complains, roomRequest, medical, laundaryRequest, messFeed
...
def mess_feedback(request):
    ...
    messFeedback = messFeed.objects.all().filter(user=request.user)
    return render(request, "mess_feedback.html", {'messFeed': messFeedback, 'form': form})
